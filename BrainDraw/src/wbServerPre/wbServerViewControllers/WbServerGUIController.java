...
//    public void runWbServerGUITester() {
//        IPField.setText("localhost");
//        dbPortField.setText("1111");
//        portField.setText("1331");
//        brokerField.setText("1332");
//       
//    }
    ...
    private void showWelcomeView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(WbServerFxmlView.WELCOME.getFxmlFile()));
    ...
    private void showConfigView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(WbServerFxmlView.CONFIG.getFxmlFile()));
    ...
    private void showConfigDbView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(WbServerFxmlView.CONFIG_DB.getFxmlFile()));
    ...
    private void showMqttConfigView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(WbServerFxmlView.MQTT.getFxmlFile()));
    ...
    public void showCurrentWbView() throws IOException {
    	 CurrentWbMonitorController.flag = false;
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(WbServerFxmlView.WB_LIST.getFxmlFile()));
    ...
    public void showMonitorView() throws IOException {
        ...
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(WbServerFxmlView.MONITOR.getFxmlFile()));
    ...
    private void baseView() {
        ...
        this.primaryStage.getIcons().add(new Image(WbServerGUIController.class.getClassLoader().getResourceAsStream("assets/imgs/whiteboard.png")));
