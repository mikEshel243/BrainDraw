...
public class ClientApplication {
    ...
    private String wbName,wbPort = null;
    ...
    public void kickUser(String visitor) {
        try {
            ...
            logger.error(e.toString());
            logger.error("Kick user service from whiteboard server fail to execute");
        }
    }
    ...
    public void userExit(String username) {
    	try {
    		 remoteWb.userExit(username);
		} catch (Exception e) {
            logger.error(e.toString());
            logger.error("Exit user service from whiteboard server fail to execute");
		}
    }
