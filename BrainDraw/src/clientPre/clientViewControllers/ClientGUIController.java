...
//    private ClientGUIController() {}
    ...
    private void showWelcomeView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(FxmlView.WELCOME.getFxmlFile()));
    ...
    private void showLoginView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(FxmlView.LOGIN.getFxmlFile()));
    ...
    private void showSignupView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(FxmlView.SIGNUP.getFxmlFile()));
    ...
    public void showChooseIdentityView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(FxmlView.IDENTITY.getFxmlFile()));
    ...
    private void showConfigView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(FxmlView.CONFIG.getFxmlFile()));
    ...
    private void showMqttConfigView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(FxmlView.MQTT.getFxmlFile()));
    ...
    private void showCurrentWbView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(FxmlView.WB_LIST.getFxmlFile()));
    ...
    private void showCreateWbView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(FxmlView.CREATE_WB.getFxmlFile()));
    ...
    public void showWhiteBoardView() throws IOException {
        this.root = FXMLLoader.load(getClass().getClassLoader().getResource(FxmlView.CANVAS.getFxmlFile()));
...
//    	loginUsernameField.setText("mike");
//    	loginPasswordField.setText("2303");
    ...
    private void baseView(boolean isResizable) {
        this.scene = new Scene(this.root);
        this.scene.getStylesheets().add(getClass().getClassLoader().getResource("assets/css/clientGUI.css").toExternalForm());
        this.primaryStage.getIcons().add(new Image(ClientGUIController.class.getClassLoader().getResourceAsStream("assets/imgs/whiteboard.png")));
