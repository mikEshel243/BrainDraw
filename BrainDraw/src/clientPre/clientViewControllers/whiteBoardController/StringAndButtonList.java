...
public class StringAndButtonList extends ListCell<String> {
    ...
    private final Image MANAGER_IMAGE = new Image(StringAndButtonList.class.getClassLoader().getResourceAsStream("assets/imgs/manager2.png"));
    //private final Image MANAGER_IMAGE = new Image(getClass().getClassLoader().getResource("@../../assets/imgs/manager2.png").toExternalForm());
    private final Image VISITOR_IMAGE = new Image(StringAndButtonList.class.getClassLoader().getResourceAsStream("assets/imgs/visitor2.png"));
    //private final Image VISITOR_IMAGE = new Image(getClass().getClassLoader().getResource("@../../assets/imgs/visitor2.png").toExternalForm());
